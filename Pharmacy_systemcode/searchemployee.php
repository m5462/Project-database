...
<section>
    ...
    <font Face="JasmineUPC" Size = "8.5" align="left" color="#0077a2" ><p><b>ข้อมูลพนักงาน</b></p>
...
$sql = "SELECT * FROM employee WHERE Emp_Firstname LIKE '%$search%'";
...
if($result->num_rows>0){
    while($row=$result->fetch_assoc()){?>
        ...
        <tr>
        <td><a href="process_delemployee.php?Emp_ID=<?php echo $row["Emp_ID"];?>" style = "color:red">delete</a>
            </td>
