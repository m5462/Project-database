...
<section>
    ...
    <font Face="JasmineUPC" Size = "8.5" align="left" color="#0077a2" ><p><b>ข้อมูลลูกค้า</b></p>
...
$sql = "SELECT * FROM customer WHERE Cus_Firstname LIKE '%$search%' ";
...
if($result->num_rows>0){
    while($row=$result->fetch_assoc()){?>
        ...
        <tr>
        <td><a href="process_delcus.php?Cus_ID=<?php echo $row["Cus_ID"];?>" style = "color:red">delete</a>
            </td>
            <td><?php echo $row['Cus_ID'];?></td>
            <td><?php echo $row['Cus_Firstname'];?></td>
            <td><?php echo $row['Cus_Lastname'];?></td>
            <td><?php echo $row['Cus_Add_No'];?></td>
            <td><?php echo $row['Cus_Add_Soi'];?></td>
            <td><?php echo $row['Cus_Add_Road'];?></td>
            <td><?php echo $row['Cus_Add_District'];?></td>
            <td><?php echo $row['Cus_Add_Province'];?></td>
            <td><?php echo $row['Cus_Add_PostalCode'];?></td>
