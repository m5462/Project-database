...
<section>
    ...
    <font Face="JasmineUPC" Size = "8.5" align="left" color="#0077a2" ><p><b>ค้นหาสินค้าที่ขายได้มากที่สุดและน้อยที่สุด</b></p>
    ...
    <form method="get" id="form" enctype="multipart/form-da" action="">
            ...
            <br>
                ...
                <!-- <button class="button button2">ลบ</button> -->
                                ...
                                <br><br><br><br>
                                <a href="searchproductmost.php">
                <button class="button button1" >สินค้าที่ขายได้มากที่สุด</button>
                <a href="searchproductleast.php">
                <button class="button button2" >สินค้าที่ขายได้น้อยที่สุด</button>
        <br><br>
