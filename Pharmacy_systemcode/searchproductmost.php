...
<section>
    ...
    <font Face="JasmineUPC" Size = "8.5" align="left" color="#0077a2" ><p><b>สินค้าที่ขายได้มากที่สุด</b></p>
...
$sql = "SELECT * FROM product ORDER BY Stock_Quantity ASC" or die("Error:".mysqli_error());
