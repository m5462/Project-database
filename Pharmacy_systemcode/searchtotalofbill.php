...
<section>
    ...
    <font Face="JasmineUPC" Size = "8.5" align="left" color="#0077a2" ><p><b>ดูยอดเงินรวมของใบเสร็จ</b></p>
...
<table border="3">
        ...
        <td>รหัสสินค้า</td>
        <td>จำนวนสินค้าที่ขาย</td>
       
        </tr>
 <?php
$search=isset($_GET['search']) ? $_GET['search']:'';
$sql = "SELECT * FROM bill_detail WHERE Bill_No LIKE '%$search%'";
