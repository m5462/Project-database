...
<section>
    ...
    <font Face="JasmineUPC" Size = "8.5" align="left" color="#0077a2" ><p><b>ค้นหาชั้นวางสินค้า</b></p>
...
<table border="3">
        <tr>
        <td>รหัสชั้นวางสินค้า</td>
        <td>ชื่อชั้นวางสินค้า</td>
        
        </tr>
 <?php

$search=isset($_GET['search']) ? $_GET['search']:'';
$sql = "SELECT * FROM shelf WHERE Shelf_Name LIKE '%$search%'";
