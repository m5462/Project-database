...
<div class="list-group">
  <a class="list-group-item" href="searchproductofleastmost.php"style="background-color:#fef568; " ><i class="fa fa-arrow-circle-left" aria-hidden="true"></i>&nbsp; BACK</a><br>
...
<section>
    ...
    <font Face="JasmineUPC" Size = "8.5" align="left" color="#0077a2" ><p><b>สินค้าที่ขายได้น้อยที่สุด</b></p>
...
$sql = "SELECT * FROM product ORDER BY Stock_Quantity DESC" or die("Error:".mysqli_error());
